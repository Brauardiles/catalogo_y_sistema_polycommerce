...
class PayMethodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pay_method" do
    assert_difference('PayMethod.count') do
      post pay_methods_url, params: { pay_method: { payable_id: @pay_method.payable_id, payable_type: @pay_method.payable_type } }
    end
  ...
  test "should update pay_method" do
    patch pay_method_url(@pay_method), params: { pay_method: { payable_id: @pay_method.payable_id, payable_type: @pay_method.payable_type } }
